...
<input type="text" placeholder="Enter Label" name="lbl1" value="cat" readonly>
<br><br>
 <label for="file-upload" class="custom-file-upload">
    <i class="fa fa-cloud-upload"></i> Custom Upload
</label>
<input id="file-upload" name="img2[]" type="file" multiple accept="image/jpeg" readonly />
<input type="text" name="lbl2" placeholder="Enter Label" value="dog">
<br><br>
